...
if (isset($_GET["aksi"])) {
    if ($_GET["aksi"] == "tambah") {
        //cek apa udah pernah add to cart
    ...
    } elseif ($_GET["aksi"] == "hapus") { //perlu di cek lagi tp gatau zz
...
<body>
    ...
    <main id="main-site">
        ...
        //include cart 
        if (isset($_SESSION['shopping_cart'])) {
            count($_SESSION['shopping_cart']) ? include('section/_cart-template.php') : include('section/notFound/_cart_notFound.php');
        } else {
            include('section/notFound/_cart_notFound.php');
        }
        //include cart 
        ?>
