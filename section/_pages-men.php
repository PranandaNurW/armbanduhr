...
<section id="shop-watches" class="py-3">
        <div class="container">
            <h5 class="font-poppins font-size-20 px-3 pt-3">Men Watches</h5>
            <hr>
            <!-- card items -->
            
            <div class="row mt-4 justify-content-center">
            <?php foreach($product_shuffle as $item) : ?>
                <?php if($item['item_type'] == 'Men') : ?>
                <div class="col-sm-3 mb-4 shop-item">
                    <div class="p-2 text-center box border">
                        <div>
                            <a href="<?php printf('%s?item_id=%s', 'product-men.php', $item['item_id']) ?>"><img src="<?= $item['item_image']??"./assets/product/men1.png"; ?>" alt="product-list1" style="width: 235px; height: 319px;" class="img-fluid"></a>
                        </div>
                        <hr>
                        <div class="pb-4">
                            <div>
