<!-- Women -->
    <section id="top-sale">
            <div class="container pb-5">
                <h4 class="font-lato font-size-20">Top-Sale Women Watches</h4> 
                <hr>
                <!-- owl carousel -->
                <div class="owl-carousel owl-theme">

                    <?php foreach($product_shuffle as $item) : ?>
                        <?php if($item['item_type'] == 'Women' && $item['item_id'] > '7' && $item['item_id'] < '14') : ?>
                    <div class="item py-2">
                        <div class="product font-lato">
                            <div class="text-center">
                            <a href="<?php printf('%s?item_id=%s', 'product-women.php', $item['item_id']) ?>"><img src="<?= $item['item_image']??"./assets/product/men1.png"; ?>" alt="topsale1" class="img-fluid mx-auto" style="width: 213px; height: 289px;" ></a>
                            </div>
                            <div class="text-center">
